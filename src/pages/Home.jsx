      ...
      <div style={{paddingTop:'100px'}} className='container px-4 mx-auto'>
        {
          ...
          <div className='flex justify-center items-center my-5 text-lg'>
            <img style={{width:'100px', height:'80px'}} className='me-2' src="https://res.cloudinary.com/bytesizedpieces/image/upload/v1656084931/article/a-how-to-guide-on-making-an-animated-loading-image-for-a-website/animated_loader_gif_n6b5x0.gif" alt="" /> Loading...
          </div>
          :
          <>
          <div className="grid grid-cols-4 gap-4">
            {
              ...
              :
              <div className="flex justify-center items-center text-red-600 my-5 text-lg">Product Not found!!!</div>
            }
          </div>
